...
function ToastComponent({ open, onOpenChange, title, description, type }: {
  open: boolean;
  ...
  const getIcon = () => {
    switch (type) {
      case 'success': return <CheckCircledIcon className="w-4 h-4 text-green-600" />;
      case 'error': return <ExclamationTriangleIcon className="w-4 h-4 text-red-600" />;
      case 'info': return <InfoCircledIcon className="w-4 h-4 text-blue-600" />;
    }
  };
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              A modern cryptocurrency analytics platform showcasing real-time social sentiment and market data
              through an enterprise-grade technology stack.
            </p>
            ...
            <div style={{
              ...
              {['Go', 'React', 'TypeScript', 'Inngest', 'Redis', 'LunarCrush'].map(tech => (
                <span key={tech} style={{
          ...
          <div>
            ...
            <ul style={{
              ...
              {[
                ...
                { name: 'Inngest Processing', desc: 'Background job orchestration' },
            ...
            <div style={{
              ...
              <div style={{
                ...
                <a
                  ...
                  onMouseEnter={(e) => e.currentTarget.style.color = 'white'}
                  onMouseLeave={(e) => e.currentTarget.style.color = 'var(--blue-400)'}
                >
...
function CryptoDashboard() {
  ...
  const triggerManualFetch = async () => {
    try {
      const response = await fetch('http://localhost:8080/dev/trigger', {
        method: 'POST',
    ...
    return (
      <div className="app-container">
        <div className="loading-container">
          ...
          <p className="loading-subtext">Fetching real-time social sentiment and market data</p>
        </div>
      </div>
    );
  }
        ...
        <div className="hero-header animate-fade-in">
          <div className="hero-content">
            ...
            <p className="hero-subtitle">
              Real-time cryptocurrency social sentiment and market data powered by cutting-edge technology
            </p>
            ...
            <div className="architecture-section animate-slide-left">
              <div className="section-header">
                ...
                <p className="section-subtitle">
                  Enterprise-grade data pipeline showcasing modern architecture patterns
                </p>
              </div>
              ...
              <div className="architecture-flow">
                <div className="flow-step">
                  ...
                  <p className="flow-step-description">
                    Model Context Protocol provides AI-ready access to real-time social sentiment data
                  </p>
                </div>
                ...
                <div className="flow-step">
                  ...
                  <p className="flow-step-description">
                    Background jobs handle data fetching, processing, and error recovery automatically
                  </p>
                </div>
                ...
                <div className="flow-step">
                  ...
                  <p className="flow-step-description">
                    High-performance caching ensures fast response times and reduces API load
                  </p>
                </div>
                ...
                <div className="flow-step">
                  ...
                  <p className="flow-step-description">
                    Lightning-fast Go backend serves clean, typed data to the React frontend
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="control-panel">
                  ...
                  <div className="metric-selector-wrapper">
                    ...
                    <div className="metric-description">
                      Select a metric to view the top 10 cryptocurrencies ranked by that criteria.
                      Each metric provides unique insights into market performance and social sentiment.
                    </div>

                    {/* Fixed Select Component */}
                    <Select.Root value={selectedMetric} onValueChange={setSelectedMetric}>
                      <Select.Trigger className="select-trigger" style={{ cursor: 'pointer' }}>
                        <div className="select-content-wrapper">
                          <span className="select-emoji">{selectedMetricOption.icon}</span>
                          <div className="select-text-content">
                            <div className="select-main-text">{selectedMetricOption.label}</div>
                            <div className="select-sub-text">{selectedMetricOption.description}</div>
                          </div>
                        </div>
                        <Select.Icon>
                          ...
                          <Select.Viewport>
                            {METRIC_OPTIONS.map((option) => (
                              ...
                              >
                                ...
                                <div style={{ flex: 1 }}>
                                  <Select.ItemText>
                                    <div style={{ fontWeight: 'var(--font-weight-medium)' }}>{option.label}</div>
                                    <div style={{ fontSize: '0.875rem', color: 'var(--gray-500)' }}>{option.description}</div>
                                  </Select.ItemText>
                                </div>
                                <Select.ItemIndicator style={{ marginLeft: 'auto' }}>
                                  <CheckCircledIcon style={{ width: '1rem', height: '1rem', color: 'var(--blue-600)' }} />
                      ...
                      <div className="stats-content">
                        ...
                        <div className="stats-grid">
                          <div className="stat-item">
                            <div className="stat-value info">{data.total_metrics}</div>
                            <div className="stat-label">Total Metrics</div>
                          </div>
                          <div className="stat-item">
                            <div className="stat-value success">{data.fetch_stats.successful_fetches}</div>
                            <div className="stat-label">Successful</div>
                          </div>
                          <div className="stat-item">
                            <div className="stat-value error">{data.fetch_stats.failed_fetches}</div>
                            <div className="stat-label">Failed</div>
                          </div>
                          <div className="stat-item">
                            <div className="stat-value warning">{data.fetch_stats.total_duration_ms}ms</div>
                ...
                <div className="results-panel">
                  <div className="results-header">
                    <div className="results-title-section">
                      <span className="results-icon">{selectedMetricOption.icon}</span>
                      <div>
                        <div className="results-title">Top 10 by {selectedMetricOption.label}</div>
                        <div className="results-subtitle">{selectedMetricOption.description}</div>
                      </div>
                    </div>
                    ...
                    <div className="results-meta">
                      {currentMetricData && (
                        <>
                          ...
                          <div>🕒 {formatLastUpdate(data?.fetch_stats.last_update || '')}</div>
                        </>
                      )}
                    </div>
                  </div>
                    ...
                    {currentMetricData && currentMetricData.success ? (
                      <div className="ranking-list">
                        {currentMetricData.all_data.slice(0, 10).map((item, index) => (
                          <div key={`${item.Symbol}-${index}`} className="ranking-item">
                            <div className="ranking-left">
                              ...
                              <div className="ranking-info">
                                ...
                                <div className="ranking-symbol">{item.Symbol?.toUpperCase()}</div>
                              </div>
                            </div>

                            <div className="ranking-right">
                              <div className="ranking-value">{item.Value}</div>
                              <div className="ranking-metric">{selectedMetricOption.category}</div>
                            </div>
                          </div>
                        ))}
                      </div>
                      ...
                      <div className="loading-container">
                        <div className="loading-spinner"></div>
                        <div className="loading-text">Processing {selectedMetricOption.label} data...</div>
                        <div className="loading-subtext">Fetching from LunarCrush API via Inngest</div>
                      </div>
                    )}
                  </div>
                </div>
